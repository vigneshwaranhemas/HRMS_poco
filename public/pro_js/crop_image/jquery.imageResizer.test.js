...
( function( $ ){
	...
	$.fn != undefined ? $.fn.imageResizer = core : console.log('JQuery 2.0.0 undefined')
					...
					// Cover only the space of the image
						...
						Cropper( originDetails, ADAPTED, function( CROPPED ){
								...
								function moving( e, MOVING, touch ){
									...
									$('#move-stats').html( '<h3>Moving</h3>'
																			+'<small>zoom: '+ zoom +' >> Max: '+ OPTIONS.zoomMax +'</small><br>'
																			+'<small>NO_MOVE: '+ NO_MOVE +'</small><br>' 
																			+'<small>deffZoom: '+ deffZoom +'</small><br><br>' 
																			
																			+'<small>ZOOMING.width: '+ ZOOMING.width +' >> '+ ADAPTED.width +'<br>ZOOMING.height: '+ ZOOMING.height +' >> '+ ADAPTED.height +'</small><br>' 
																			+'<small>ZOOMING.left: '+ ZOOMING.left +' >> '+ ADAPTED.left +'<br>ZOOMING.top: '+ ZOOMING.top +' >> '+ ADAPTED.top +'</small><br><br>' 
																			
																			+'<small>ZOOMED_IMG.left: '+( -MOVING.ox * deffZoom )+'</small><br>' 
																			+'<small>ZOOMED_IMG.top: '+( -MOVING.oy * deffZoom )+'</small><br><br>'
																			
																			+'<small>MoveLimitLeft: '+ M_X +' => ( '+ ADAPTED.left +', '+ MoveLimitLeft +' ) >> '+ LEFT +'</small><br>' 
																			+'<small>MoveLimitTop: '+ M_Y +' => ( '+ ADAPTED.top +', '+ MoveLimitTop +' ) >> '+ TOP +'</small><br>'
																			+'<small>MoveLimitRight: '+ M_X +' => ( '+ ADAPTED.left +', '+ MoveLimitRight +' ) >> '+ LEFT +'</small><br>' 
																			+'<small>MoveLimitBottom: '+ M_Y +' => ( '+ ADAPTED.top +', '+ MoveLimitBottom +' ) >> '+ TOP +'</small><br>'
																		)
								...
								function resizing( e, RESIZING, touch ){
									...
									var POS_X = ( touch ? e.originalEvent.touches[0].pageX : e.pageX ) - $_CROPPER.offset().left,
									...
									$('#move-stats').html( '<h3>Resizing</h3>'
																			+'<small>zoom: '+ zoom +' >> Max: '+ OPTIONS.zoomMax +'</small><br>'
																			+'<small>NO_MOVE: '+ NO_MOVE +'</small><br><br>'
																			+'<small>Resize type: '+ RESIZING.t.data('action') +'</small><br>' 
																			+'<small>Min Cropping sizes: '+ MIN_WIDTH +'x'+ MIN_HEIGHT +'</small><br><br>' 
																			
																			+'<small>ZOOMING.width: '+ ZOOMING.width +' >> '+ ADAPTED.width +'<br>ZOOMING.height: '+ ZOOMING.height +' >> '+ ADAPTED.height +'</small><br>' 
																			+'<small>ZOOMING.left: '+ ZOOMING.left +' >> '+ ADAPTED.left +'<br>ZOOMING.top: '+ ZOOMING.top +' >> '+ ADAPTED.top +'</small><br><br>' 
																			
																			+'<small>CROPPER.width: '+ SC_WIDTH +' >> '+ ADAPTED.width +'<br>CROPPER.height: '+ SC_HEIGHT +' >> '+ ADAPTED.height +'</small><br>' 
																			+'<small>CROPPER.top: '+( TOP )+'<br>CROPPER.left: '+( LEFT )+'</small><br><br>'
																			
																			+'<small>ResizeLimitLeft: ( '+ ADAPTED.left +', '+ ResizeLimitLeft +' )</small><br>' 
																			+'<small>ResizeLimitTop: ( '+ ADAPTED.top +', '+ ResizeLimitTop +' )</small><br>'
																			+'<small>ResizeLimitRight: ( '+ ADAPTED.left +', '+ ResizeLimitRight +' )</small><br>' 
																			+'<small>ResizeLimitBottom: ( '+ ADAPTED.top +', '+ ResizeLimitBottom +' )</small><br>'
																		)
