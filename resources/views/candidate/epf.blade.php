...
<tbody>
    ...
    <tr>
        ...
        <td><input type="text" class="form-control" name="emp_name" id="emp_name" required></td>
    </tr>
    <tr>
        <td>2</td>
        <td><div class="form-group m-t-15 m-checkbox-inline mb-0 custom-radio-ml">
            <div class="radio radio-primary">
              <input id="father_name" class="fsname" type="radio" name="name" value="" required>
              <label class="mb-0" for="father_name">Father's Name</label>
            </div>
            <div class="radio radio-primary">
              <input id="spouse_name" class="fsname" type="radio" name="name" value="">
              <label class="mb-0" for="spouse_name">Spouse's Name</label>
            </div></div>
          <p>(Please click whichever is applicable)</p>
          </td>
        <td><input type="text" name = "f_name" id = "f_name" class="form-control test_name">
          <input style ="display:none" type="text" name = "s_name" id = "s_name" class="form-control test_name"></td>
    </tr>
    ...
    <tr>
        ...
        <td><div class="form-group m-t-15 m-checkbox-inline mb-0 custom-radio-ml">
            ...
            <div class="radio radio-primary">
                ...
                <label class="mb-0" for="transgender">Transgender</label>
              </div>
        </div>
        </td>
    </tr>
    <tr>
        ...
        <td><div class="form-group m-t-15 m-checkbox-inline mb-0 custom-radio-ml">
            <div class="radio radio-primary">
              <input id="married" type="radio" name="mar_status" value="Married" required>
              <label class="mb-0" for="married">Married</label>
            </div>
            <div class="radio radio-primary">
              <input id="unmarried" type="radio" name="mar_status" value="Unmarried">
              <label class="mb-0" for="unmarried">Unmarried</label>
            </div>
            <div class="radio radio-primary">
                <input id="widow" type="radio" name="mar_status" value="Widow">
                <label class="mb-0" for="widow">Widow</label>
              </div>
              <div class="radio radio-primary">
                <input id="widower" type="radio" name="mar_status" value="Widower">
                <label class="mb-0" for="widower">Widower</label>
              </div>
            
              <div class="radio radio-primary">
                <input id="divorcee" type="radio" name="mar_status" value="Divorcee">
                <label class="mb-0" for="divorcee">Divorcee</label>
              </div>
        </div>
        </td>
    </tr>
    <tr>
        <td>6</td>
        <td>Email id</td>
        <td><input type="text" name="email_id" id="email_id" class="form-control" required>
        <span id="error_email" style="color:red; display:none;">Please enter valid Email Address!!!</span>
        </td>
    </tr>
    <tr>
        <td>7</td>
        <td>Mobile Number</td>
        <td><input type="number"  name="mob_no" id="mob_no" class="form-control" required>
          <span id="err_msg" style="color:red; display:none;">Please enter valid Mobile Number!!!</span>
        </td>
    </tr>
    <tr>
        <td>8</td>
        ...
        <td><div class="form-group m-t-15 m-checkbox-inline mb-0 custom-radio-ml">
            <div class="radio radio-primary">
              <input id="epf_yes" type="radio" name="epf" value="Yes" required>
              <label class="mb-0" for="epf_yes">Yes</label>
            </div>
            <div class="radio radio-primary">
              <input id="epf_no" type="radio" name="epf" value="No">
              <label class="mb-0" for="epf_no">No</label>
            </div>
    ...
    <tr>
        ...
        <td><div class="form-group m-t-15 m-checkbox-inline mb-0 custom-radio-ml">
            <div class="radio radio-primary">
              <input id="epsyes" type="radio" name="eps" value="Yes" required>
              <label class="mb-0" for="epsyes">Yes</label>
            </div>
            <div class="radio radio-primary">
              <input id="epsno" type="radio" name="eps" value="No">
              <label class="mb-0" for="epsno">No</label>
            </div>
    ...
    <tr>
        ...
        <td>Previous employment details: [if Yes to 8 AND/OR 9 above]<br>
            ...
            <td><input type="text" class="form-control pmd" name="uan" id="uan"></td>
    ...
    <tr>
        ...
        <td> b). Previous PF Account Number
            ...
            <td><input type="text" class="form-control pmd" name="ppf" id="ppf"></td>
    ...
    <tr>
        ...
        <td> c). Date of Exit from Previous Employment
            ...
            <td><input type="date" class="form-control pmd" name="pr_exit_date" id="pr_exit_date"></td>
    ...
    <tr>
        ...
        <td> d). Scheme Certificate Number (if issues)
            ...
            <td><input type="text" class="form-control" name="scn" id="scn"></td>
    ...
    <tr>
        ...
        <td> e).Pension Payment Number(PPO) (if issues)
            ...
            <td><input type="text" class="form-control" name="ppo" id="ppo"></td>
    ...
    <tr>
        ...
        <td>a.)International Worker
            ...
            <td><div class="form-group m-t-15 m-checkbox-inline mb-0 custom-radio-ml">
                <div class="radio radio-primary">
                  <input id="int_yes" type="radio" name="inter_worker" value="Yes" required>
                  <label class="mb-0" for="int_yes">Yes</label>
                </div>
                <div class="radio radio-primary">
                  <input id="int_no" type="radio" name="inter_worker" value="No">
                  <label class="mb-0" for="int_no">No</label>
                </div>
    ...
    <tr>
        ...
        <td> b).If yes, State country of origin(India/Name of other country)
            ...
            <td><input type="text" class="form-control sco" name="sco" id="sco"></td>
    ...
    <tr>
        ...
        <td> c).Passport no
          ...
          <td><input type="text" class="form-control sco" name="passport_no" id="passport_no"></td>
    ...
    <tr>
        ...
        <td> c).Vality of passport
            ...
            <td>From<input type="date" name ="from_date" class="form-control sco">To<input type="date" name ="to_date" class="form-control sco"></td>
    ...
    <tr>
        ...
        <td>KYC Details: (attach self attested copies off following KYCs)<br>
            ...
            <td><input type="text" class="form-control" name="bank_account" id="bank_account" required></td>
    ...
    <tr>
        ...
        <td> b).AADHAR Number
            ...
            <td><input type="text" class="form-control" name="aadhar" id="aadhar" required></td>
    ...
    <tr>
        ...
        <td> c).Permanent Account Number (PAN) (if available)
            ...
            <td><input type="text" class="form-control" name="pan" id="pan"></td>
...
<script src="../assets/pro_js/epf.js"></script>

<script>
var save_epf_form_link = "{{url('save_epf_form')}}";
