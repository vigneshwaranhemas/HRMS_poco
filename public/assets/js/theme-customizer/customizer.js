    ...
    $("body").attr("class", "dark-only");
         $('<div class="customizer-links">\
            <div class="nav flex-column nac-pills" id="c-pills-tab" role="tablist" aria-orientation="vertical">\
                 <a class="nav-link" id="c-pills-home-tab" data-toggle="pill" href="#c-pills-home" role="tab" aria-controls="c-pills-home" aria-selected="true">\
                     <div class="settings"><img src="../assets/images/customize.png" alt="" /></div></a>\
                  ...
                  <div class="customizer-body custom-scrollbar">\
                     <i class="icofont-close icon-close"></i>\
                          ...
                          <div class="tab-pane fade " id="c-pills-profile" role="tabpanel" aria-labelledby="c-pills-profile-tab">\
                            <h6>Light layout</h6><ul class="layout-grid customizer-color">\
                              <li class="color-layout" data-attr="color-1" data-primary="#7e37d8" data-secondary="#fe80b2"><div></div></li>\
                              <li class="color-layout" data-attr="color-2" data-primary="#0288d1" data-secondary="#26c6da"><div></div></li>\
                              <li class="color-layout" data-attr="color-3" data-primary="#8e24aa" data-secondary="#ff6e40"><div></div></li>\
                              ...
                              <li class="color-layout" data-attr="color-6" data-primary="#3949ab" data-secondary="#4fc3f7"><div></div></li></ul>\
                              <h6 class="">Dark Layout</h6><ul class="layout-grid customizer-color dark">\
                              <li class="color-layout" data-attr="color-1" data-primary="#7e37d8" data-secondary="#fe80b2"><div></div></li>\
                              <li class="color-layout" data-attr="color-2" data-primary="#0288d1" data-secondary="#26c6da"><div></div></li>\
                              <li class="color-layout" data-attr="color-3" data-primary="#8e24aa" data-secondary="#ff6e40"><div></div></li>\
                              <li class="color-layout" data-attr="color-4" data-primary="#4c2fbf" data-secondary="#2e9de4"><div></div></li>\
                              <li class="color-layout" data-attr="color-5" data-primary="#7c4dff" data-secondary="#7b1fa2"><div></div></li>\
                              <li class="color-layout" data-attr="color-6" data-primary="#3949ab" data-secondary="#4fc3f7"><div></div></li></ul>\
                              <h6 class="">Mix Layout</h6><ul class="layout-grid customizer-mix"><li class="color-layout active" data-attr="light-only">\
                            ...
                            <li class="color-layout" data-attr="sidebar-dark">\
                            <div class="header bg-light">\
                            <ul>\
                           <li></li><li></li><li></li></ul></div>\
                           <div class="body"><ul><li class="bg-dark sidebar">\
                            </li><li class="bg-light body"></li></ul>\
                           </div></li>\
                           <li class="color-layout" data-attr="dark-only">\
                           <div class="header bg-dark"><ul><li></li><li></li><li></li></ul></div>\
                           <div class="body"><ul><li class="bg-dark sidebar"></li>\
               <li class="bg-dark body"></li></ul></div></li></ul></div></div></div></div>').appendTo($('body'));
(function() {
})();
//live customizer js
