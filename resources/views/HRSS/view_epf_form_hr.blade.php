...
<tbody>
    ...
    <tr>
        ...
        <td><input type="text" class="form-control" name="emp_name" id="emp_name" readonly>
            </td>
    </tr>
    <tr>
        <td>2</td>
...
<p  style="text-align:justify;">A.	The	member   Mr/Ms/Mrs  <input class="input" type="text" name="emp_name" id="emp_name_edit" required>	has  joined  on  <input class="input" type="date" name="a_pf_no" id="a_pf_no" required> and has been allotted PF Number</p>
<p  style="text-align:justify;">B.	In case the person was earlier not a member of EPF Scheme, 1952 and EPS, 1995:</p>
<p  style="text-align:justify;">•	<span style="font-weight:bold;">(Post aIlotment of UAN)</span> The UAN allotted for the member is<input class="input" type="text" name="a_uan_no" id="a_uan_no" required></p>
    ...
    <p  style="text-align:justify;"><input type="radio" name="ekyc_status" value="Have not been uploaded" required>  Have not been uploaded</p>
    <p  style="text-align:justify;"><input type="radio" name="ekyc_status" value="Have been uploaded but not approved"> Have been uploaded but not approved</p>
    <p  style="text-align:justify;"><input type="radio" name="ekyc_status" value="Have been uploaded and approved  with DSC">Have been uploaded and approved  with DSC</p>
    ...
    <p  style="text-align:justify; font-weight:bold;">•	Please Tick the Appropriate Option:</p>
    <p  style="text-align:justify;"><input type="radio" name="sign_status" value="verified" required> The KYC details of the above member in the UAN database have been approved with Digital Signature Certificate and<br> transfer request has been generated on portal</p>
    <p  style="text-align:justify;"><input type="radio" name="sign_status" value="not-verified">  As the DSC of establishment are not registered with EPFO, the member has been informed to file physical claim (Form no:13) for transfer of funds from his previous establishment.</p>
...
<script src="../assets/pro_js/view_epf_hr.js"></script>

<script>
var get_epf_form_hr_link = "{{url('view_epf_form_hr')}}";
