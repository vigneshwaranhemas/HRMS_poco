                ...
                $html .= '<td>';
                    ...
                    foreach($row_values->$cell3 as $cell3_value){
                        ...
                        if($cell3_value != null){
                            ...
                            $html .= '<p style="border-bottom: 1px solid rgb(242 244 255)">'.$cell3_value.'</p>';
                ...
                $html .= '<td>';
                    ...
                    foreach($row_values->$cell4 as $cell4_value){
                        ...
                        if($cell4_value != null){
                            ...
                            $html .= '<p style="border-bottom: 1px solid rgb(242 244 255)">'.$cell4_value.'</p>';
                ...
                $html .= '<td>';
                    ...
                    foreach($row_values->$cell5 as $cell5_value){
                        ...
                        if($cell5_value != null){
                            ...
                            $html .= '<p style="border-bottom: 1px solid rgb(242 244 255)">'.$cell5_value.'</p>';
                ...
                $html .= '<td>';
                    ...
                    foreach($row_values->$cell6 as $cell6_value){
                        ...
                        if($cell6_value != null){
                            ...
                            $html .= '<p style="border-bottom: 1px solid rgb(242 244 255)">'.$cell6_value.'</p>';
            ...
            if($row_values->$cell10 != null){
             ...
             if($row_values->$cell11 != null){
                $html .= '<td>';
                    foreach($row_values->$cell11 as $cell11_value){
                        if($cell11_value != null){
                            $html .= '<p class="hr_remark_p'.$cell1.'">'.$cell11_value.'</p>';
                        }
                    }
