...
$(()=>{
   ...
   $.ajax({
       ...
       method:"POST",
       data: $("#add_business_unit").serialize(),
       dataType:"json",
       ...
       error: function(response) {
        ...
        $('#business_name_error').text(response.responseJSON.errors.business_name);
...
table_cot = $('#business_data').DataTable({
    ...
    // ],
    ajax: {
        url: get_business_unit_link_database,
        type: 'POST',
        dataType: "json",
        data: function (d) {
...
function business_edit_process(id){

    $('#business_edit_pop_modal_div').modal('show');

    $.ajax({
        url: get_business_unit_details_link,
        method: "POST",
        data:{"id":id,},
        dataType: "json",
        success: function(data) {
...
$("#editUpdate").on('click', function() {
    ...
    $.ajax({
        url: update_business_unit_details_link,
        method: "POST",
        data:{
            "id":ed_id,
            "business_name":ed_business_name,
        },
        dataType: "json",
        success: function(data) {
...
function business_status_process(id, status_data){
    ...
    $("#confirmSubmit").on('click', function() {
        ...
        $.ajax({
            url: process_business_unit_status_link,
            method: "POST",
...
function business_delete_process(id){
    ...
    $("#deleteconfirmSubmit").on('click', function() {
        ...
        $.ajax({
            url: process_business_unit_delete_link,
            method: "POST",
            data:{"id":id,},
            dataType: "json",
            success: function(data) {
