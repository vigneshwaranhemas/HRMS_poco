...
$(()=>{
   ...
   $.ajax({
       url:add_designation_process_link,
       method:"POST",
       data: $("#form_add_designation").serialize(),
       dataType:"json",
...
table_cot = $('#designation_data').DataTable({
    ...
    // ],
    ajax: {
        url: get_designation_link_database,
        type: 'POST',
        dataType: "json",
        data: function (d) {
    ...
    createdRow: function( row, data, dataIndex ) {
        ...
        $( row ).find('td:eq(1)').attr('data-label', 'Designation Name');
...
function designation_edit_process(id){

    $('#designation_edit_pop_modal_div').modal('show');

    $.ajax({
        url: get_designation_details_link,
        method: "POST",
        data:{"id":id,},
        dataType: "json",
        success: function(data) {
            ...
            if(data.length !=0){
                $('#designation_name').val(data[0].designation_name);
                $('#ed_id').val(id);
            }
        }
    });
...
$("#editUpdate").on('click', function() {
    // alert("abc");
    var ed_designation_name = $('#designation_name').val();
    var ed_id = $('#ed_id').val();

    $.ajax({
        url: update_designation_details_link,
        method: "POST",
        data:{
            "id":ed_id,
            "designation_name":ed_designation_name,
        },
        dataType: "json",
        success: function(data) {
            ...
            $('#designation_edit_pop_modal_div').click();
        ...
        error: function(response) {
            ...
            $('#edit_designation_name_error').text(response.responseJSON.errors.designation_name);
...
function designation_status_process(id, status_data){
    // $('#confirmbox').click();
    ...
    $("#confirmSubmit").on('click', function() {
        ...
        $.ajax({
            url: process_designation_status_link,
            method: "POST",
...
function designation_delete_process(id){
    // $('#confirmbox').click();
    ...
    $("#deleteconfirmSubmit").on('click', function() {
        ...
        $.ajax({
            url: process_designation_delete_link,
            method: "POST",
            data:{"id":id,},
            dataType: "json",
            success: function(data) {
