...
$(()=>{
   ...
   $.ajax({
       url:add_function_process_link,
       method:"POST",
       data: $("#add_function_unit").serialize(),
       dataType:"json",
       ...
       error: function(response) {
        ...
        $('#function_name_error').text(response.responseJSON.errors.function_name);
...
table_cot = $('#function_data').DataTable({
    ...
    // ],
    ajax: {
        url: get_function_link_database,
        type: 'POST',
        dataType: "json",
        data: function (d) {
    ...
    createdRow: function( row, data, dataIndex ) {
        ...
        $( row ).find('td:eq(1)').attr('data-label', 'Function Name');
...
function function_edit_process(id){

    $('#function_edit_pop_modal_div').modal('show');

    $.ajax({
        url: get_function_details_link,
        method: "POST",
        data:{"id":id,},
        dataType: "json",
        success: function(data) {
            ...
            if(data.length !=0){
                $('#function_name').val(data[0].function_name);
                $('#ed_id').val(id);
            }
        }
    });
...
$("#editUpdate").on('click', function() {
    ...
    $.ajax({
        url: update_function_details_link,
        method: "POST",
        data:{
            "id":ed_id,
            "function_name":ed_function_name,
        },
        dataType: "json",
        success: function(data) {
...
function function_status_process(id, status_data){
    ...
    $("#confirmSubmit").on('click', function() {
        ...
        $.ajax({
            url: process_function_status_link,
            method: "POST",
...
function function_delete_process(id){
    ...
    $("#deleteconfirmSubmit").on('click', function() {
        ...
        $.ajax({
            url: process_function_delete_link,
            method: "POST",
            data:{"id":id,},
            dataType: "json",
            success: function(data) {
