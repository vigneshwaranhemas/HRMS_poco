...
@section('title', 'EPf Form Details')
...
@section('breadcrumb-title')
	<h2>EPf  Form Details<span> </span></h2>
@endsection
        ...
        <div class="card">
          <div class="card-body">
            <div class="dt-ext table-responsive">
              <table class="display" id="epf_medical_data">
                <thead>
                  <tr>
                    <th>S.No</th>
                    <th>Employee Id</th>
...
<script src="../assets/pro_js/epf_list.js"></script>


<script>
    var get_epf_database = "{{url('epf_details')}}";
