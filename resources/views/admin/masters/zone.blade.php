...
@section('breadcrumb-items')
   {{-- <li class="breadcrumb-item">Dashboard</li>
    ...
    <button class="btn btn-primary" type="button" data-toggle="modal" data-original-title="test" data-target="#exampleModal">Add Zone</button>
@endsection
              ...
              <div class="modal-body">
                  <div class="form-row">
                      <div class="col-md-12 mb-3">
                        ...
                        <div class="text-warning" id="edit_zone_name_error"></div>
                      </div>
