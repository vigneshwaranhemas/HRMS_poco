        ...
        <div class="card">
          <div class="card-body">
            <div class="dt-ext table-responsive">
              <table class="display" id="band_data">
                <thead>
                  <tr>
                    <th>S.No</th>
                    <th>Band</th>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Band Unit Status</h5>
...
<div class="modal fade" id="delete_pop_modal_div" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Band Unit Delete</h5>
              <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
          </div>
...
<div class="modal fade" id="band_edit_pop_modal_div" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Edit Band Unit Details</h5>
              <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
          </div>
...
<script src="../assets/pro_js/band.js"></script>

<script>
var add_band_process_link = "{{url('add_band_process')}}";
var get_band_link_database = "{{url('get_band_database')}}";
var get_band_details_link = "{{url('get_band_details')}}";
var update_band_details_link = "{{url('update_band_details')}}";
var process_band_status_link = "{{url('process_band_status')}}";
var process_band_delete_link = "{{url('process_band_delete')}}";
</script>
@endsection
