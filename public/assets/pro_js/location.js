...
$(()=>{
   ...
   $.ajax({
       url:add_location_process_link,
       method:"POST",
       data: $("#form_add_location").serialize(),
       dataType:"json",
       ...
       error: function(response) {
        ...
        $('#location_name_error').text(response.responseJSON.errors.location_name);
...
table_cot = $('#location_data').DataTable({
    ...
    // ],
    ajax: {
        url: get_location_link_database,
        type: 'POST',
        dataType: "json",
        data: function (d) {
    ...
    createdRow: function( row, data, dataIndex ) {
        ...
        $( row ).find('td:eq(1)').attr('data-label', 'Location Name');
...
function location_edit_process(id){

    $('#location_edit_pop_modal_div').modal('show');

    $.ajax({
        url: get_location_details_link,
        method: "POST",
        data:{"id":id,},
        dataType: "json",
        success: function(data) {
...
$("#editUpdate").on('click', function() {
    ...
    $.ajax({
        url: update_location_details_link,
        method: "POST",
        data:{
            "id":ed_id,
            "location_name":ed_location_name,
        },
        dataType: "json",
        success: function(data) {
...
function location_status_process(id, status_data){
    // $('#confirmbox').click();
    $('#location_pop_modal_div').modal('show');

    $("#confirmSubmit").on('click', function() {
        $('#close_status_pop').click();

        $.ajax({
            url: process_location_status_link,
            method: "POST",
...
function location_delete_process(id){
    // $('#confirmbox').click();
    ...
    $("#deleteconfirmSubmit").on('click', function() {
        ...
        $.ajax({
            url: process_location_delete_link,
            method: "POST",
            data:{"id":id,},
            dataType: "json",
            success: function(data) {
