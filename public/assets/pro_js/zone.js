...
$(()=>{
   ...
   $.ajax({
       url:add_zone_process_link,
       method:"POST",
       data: $("#form_add_zone").serialize(),
       dataType:"json",
       ...
       error: function(response) {
        ...
        $('#zone_name_error').text(response.responseJSON.errors.zone_name);
...
table_cot = $('#zone_data').DataTable({
    ...
    createdRow: function( row, data, dataIndex ) {
        ...
        $( row ).find('td:eq(1)').attr('data-label', 'Zone Name');
...
function zone_edit_process(id){

    $('#zone_edit_pop_modal_div').modal('show');

    $.ajax({
        url: get_zone_details_link,
        method: "POST",
        data:{"id":id,},
        dataType: "json",
        success: function(data) {
...
$("#editUpdate").on('click', function() {
    // alert("abc");
    var ed_zone_name = $('#zone_name').val();
    var ed_id = $('#ed_id').val();

    $.ajax({
        url: update_zone_details_link,
        method: "POST",
        data:{
            "id":ed_id,
            "zone_name":ed_zone_name,
        },
        dataType: "json",
        success: function(data) {
        ...
        error: function(response) {
            ...
            $('#edit_zone_name_error').text(response.responseJSON.errors.zone_name);
