							...
							<form id="supGoalsForm">
								...
								<!-- <div class="m-t-20 m-b-30 float-right"> -->
									<div class="row m-t-20 m-b-30" id="save_div">
										...
										<div class="col-lg-12">
											<a onclick="supFormSave();" id="sup_save_table" class="btn btn-primary text-white m-t-30" title="Save As Draft">Save As Draft</a>
											<a onclick="supFormSave();" id="sup_update_table" class="btn btn-primary text-white m-t-30 sup_update_table" title="Save As Draft">Update</a>
										</div>
									</div>
								<!-- </div> -->
							</form>
